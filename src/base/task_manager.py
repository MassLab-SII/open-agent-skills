...
class BaseTaskManager(ABC):
    ...
    def get_task_instruction(self, task: BaseTask) -> str:
        ...
        return self._format_task_instruction(base_instruction, task)
    ...
    def _format_task_instruction(self, base_instruction: str, task: BaseTask = None) -> str:
        """
        Format task instruction with additional context.
        
        Args:
            base_instruction: The base task instruction text
            task: The task object (may contain backup_path and other metadata)
            
        Returns:
            Formatted instruction string
        """
        formatted = base_instruction
        
        # Add backup path information if available
